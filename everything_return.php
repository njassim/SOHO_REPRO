...
if ($_POST['everything_return'] == '1') {
    ...
    if ((count($if_plotting) > 0) && (count($if_arch) > 0)) {
        ...
        <div style="width: 100%;float: left;height: 20px;margin-bottom: 5px;">
            ...
            <div style="width: 20%;float: left;text-align: center;border: 1px #F99B3E solid;border-bottom: 0px;font-weight: bold;cursor: pointer;" onclick="return everything_return();">Plotting</div>
            <div style="width: 5%;float: left;border-bottom: 1px #F99B3E solid;border-left: 0px;border-top: 0px;">&nbsp;</div>
            <div style="width: 20%;float: left;text-align: center;border: 1px #F99B3E solid;font-weight: bold;cursor: pointer;" onclick="return everything_return_arch();">Architectural</div>
            <div style="width: 48%;float: left;border: 1px #F99B3E solid;border-left: 0px;border-top: 0px;border-right: 0px;">&nbsp;</div>
        </div>
        <input type="hidden" name="arch_exist" class="arch_exist" id="arch_exist" value="<?php echo count($if_arch); ?>" />
