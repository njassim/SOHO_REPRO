...
<!--                                  <span style="font-weight:bold;color:#cc0000">
                ...
                <div class="check" style="width:730px;border-top: 1px solid #FF7E00;margin-top:-13px;">
                  <div style="width:150px;float:left;">
                      <input class="filetrigger" name="alt_file_option" value="pickUp" id="pick_1" style="margin-left: 5px; float: left; width: 10px; margin-top: 10px !important;" type="radio" onclick="return show_date_picker(<?php echo '1'; ?>);" />
                  ...
                  <div style="width:175px;float:left;">
                      <input class="filetrigger" name="alt_file_option" value="dropOff" id="drop" style="margin-left: 5px; float: left; width: 10px; margin-top: 10px !important;" type="radio" onclick="return drop_sohorepro(<?php echo '1'; ?>);" />
                    <label for="drop" style="float:left;margin-left:2px;margin-top:10px;height:10px;">
                      Drop off at Soho Repro
                    </label>                    
                  </div>
                    <div style="width:150px;float:left;">
                      <input class="filetrigger" name="alt_file_option" value="dropOff" id="drop" style="margin-left: 5px; float: left; width: 10px; margin-top: 10px !important;" type="radio" onclick="return upload_soho(<?php echo '1'; ?>);" />
                    <label for="drop" style="float:left;margin-left:2px;margin-top:10px;height:10px;">
                      Upload File
                    </label>                    
                  </div>
                    <div style="width:150px;float:left;">
                      <input class="filetrigger" name="alt_file_option" value="dropOff" id="drop" style="margin-left: 5px; float: left; width: 10px; margin-top: 10px !important;" type="radio" onclick="return provide_link(<?php echo '1'; ?>);" />
                    <label for="drop" style="float:left;margin-left:2px;margin-top:10px;height:10px;">
...
<!--                                  <span style="font-weight:bold;color:#cc0000">
                ...
                <div class="check" style="width:730px;border-top: 1px solid #FF7E00;margin-top:-13px;">
                  ...
                  <br>
                      ...
                      <div id="date_time_1" style="padding-top: 10px;border: 1px #FF7E00 solid;margin-top: 7px;float: left;width: 35%;padding-bottom: 10px;display:none;">
                        <input type="hidden" name="all_exist_date" id="all_exist_date" value="<?php echo $all_date_exist; ?>" />
                        <input type="text" name="dahe_for_alt" id="date_for_alt_1" style="width: 50%;" class="date_for_alt" />                        
                        <select class="" id="time_for_alt_1" name="time_gap" id="time_gap" style="width: 35% !important;">
                                <option value="08:00AM">08:00AM</option>
                                <option value="09:00AM">09:00AM</option>
                                <option value="10:00AM">10:00AM</option>
        ...
        $.ajax
                ({
                    ...
                    {   
                        ...
                        $("#succ_msg").show();
                        //$("#succ_msg").hide(1000);
                        $("#set_2").append(result[1]).fadeIn('slow');
                        $("#original_"+result[0]).focus();
