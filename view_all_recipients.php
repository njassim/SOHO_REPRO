...
//                        echo '</pre>';
                ...
                <div style="float: left;width: 65%;margin-left: 30px;margin-top: 5px;">
                    FTP Link : <?php echo $cust_original_order[0]['ftp_link']; ?>
                </div>
                
                <div style="float: left;width: 65%;margin-left: 30px;margin-top: 5px;">
                    User Name : <?php echo $cust_original_order[0]['user_name']; ?>
                </div>
                
                <div style="float: left;width: 65%;margin-left: 30px;margin-top: 5px;">
                    Password : <?php echo $cust_original_order[0]['password']; ?>
                </div>
                <?php
                }
                ?>
        ...
        <div id="set_form">
            <div id="plotting" action="" method="post" class="systemForm orderform">
                ...
                <div style="float: left;width: 33%;margin-left: 30px;">  
                    ...
                    echo $shipp_add[0]['company_name'] . '<br>Attention:  '.$entered_sets['attention_to'].'<br>'.'Conatct:  '.$entered_sets['contact_ph'].'<br>'. $shipp_add[0]['address_1'] . '<br>' . $add_2 . $shipp_add[0]['city'] . '&nbsp;' . StateName($shipp_add[0]['state']) . '&nbsp;' . $shipp_add[0]['zip'].'<br>'.$shipp_add[0]['phone'];
