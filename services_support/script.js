...
$(document).ready(function () {
	...
	//console.log( $(this).parent());
		...
		//$(this).next.toggle();
		    ...
		    $('ul.acc> li>h2>div>img').attr('src','/public/images/r1.png');
		    ...
		    */ //17 may
		    ...
		    //$('ul.acc> li> div.acc-section:visible').siblings('h2').children('div.eachlistfullTotal').attr('catotal','0');
	            $('ul.acc> li>div').hide();	
                    ...
                    $(this).siblings('h2').children().children().attr('src','/public/images/d1.png');
		    ...
		    $('ul.acc> li>div.acc-section>div.acc-content>ul.acc>li>h3>div>img').attr('src','/public/images/r2.png');
		    $('ul.acc> li>div.acc-section>div.acc-content>ul.acc>li>div').hide();
                    $(this).children().children().attr('src','/public/images/d2.png');
		   ...
		   if($(this).parent().is(":last-child")){
            ...
            display.show(); 
                ...
                if($(this)[0].tagName == 'H2') {
                    ...
                    $(this).siblings('h2').children().children().attr('src','/public/images/r1.png');
		    ...
		    $(this).children('div.eachlistfullTotal').css('color','#C4C4C4');
                ...
                if($(this)[0].tagName == 'H3') {
                    $(this).children().children().attr('src','/public/images/r2.png');
