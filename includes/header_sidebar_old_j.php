...
<div id="content_usermeta">
    ...
    <div style="border-top: 1px solid #EEEEEE;height:20px;padding-top:5px;font-size: 20px;color: #fff;font-weight: bold;"> 
     Existing Users   
    </div>
    <div id="user-status">        
        <div>
    ...
    echo $_COOKIE['ck_sohorepro_pass'];
        ...
        <div id="panalLoginHelp">
            <div class="sideheadline">
                <a href="existing_customer.php" style="text-decoration: none;color: #fff  !important;font-weight: bold;font-size: 17px;">
                Existing Account -<br>
                New User Setup</a>
            </div>
            <div class="sideheadline" style="margin-top: 10px;">
                <a href="new_account_add.php" style="text-decoration: none;color: #fff  !important;font-weight: bold;font-size: 17px;">
                Request New Account
            </div>
