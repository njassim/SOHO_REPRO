    ...
    echo $_COOKIE['ck_sohorepro_pass'];
        ...
        <div id="panalLoginHelp">
            <div class="sideheadline">
                Existing Account Users.<br>
                <a href="existing_customer.php" style="text-decoration: none;color: #000  !important;">Click Here</a>
            </div>
            <div class="sideheadline" style="margin-top: 10px;">
                New Account.<br>
                <a href="new_account_add.php" style="text-decoration: none;color: #000  !important;">Click Here</a>
            </div>
