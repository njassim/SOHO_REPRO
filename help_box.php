...
$open_orders_customers  = CustomersOpenOrders();
...
<!--                <input type="hidden" name="comp_id" id="comp_id" value="<?php echo $comp_id; ?>" /> 
            ...
            <table width="740">
                <!--<tr>
                    <td><span style="font-weight: bold;">Select the Company Name</span></td>
                    <td>
                        <select name="comp_id" id="comp_id" style="width: 150px;">
                          <option value="0">---Select CUstomer---</option>  
                        <?php 
                        foreach ($open_orders_customers as $cust_oo) {
                        ?>
                                <option value="<?php echo $cust_oo['comp_id']; ?>"><?php echo $cust_oo['comp_name']; ?></option>
                        <?php                           
                        }
                        ?>                       
                    </select>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="first_name" id="first_name" style="border: 1px #ccc solid;margin-top: 10px; margin-bottom: 10px;" />
                    </td>
                </tr>
                <tr>
                    <td><span style="font-weight: bold;">Last Name</span><span style="color: red;">*</span></td>
                    <td>
                        <input type="text" name="last_name" id="last_name" style="border: 1px #ccc solid;margin-top: 10px; margin-bottom: 10px;" />
                    </td>
                </tr>
                <tr>
                    <td><span style="font-weight: bold;">Email</span><span style="color: red;">*</span></td>
                    <td>
                        <input type="text" name="user_mail" id="user_mail" style="border: 1px #ccc solid;margin-top: 10px; margin-bottom: 10px;" />
                    </td>
                </tr>
                <tr>
...
function submit_feedback()
{
 ...
 var test_mail          =   filter_email.test(user_mail);
    if(first_name == '')
       {
           document.getElementById('first_name').focus();           
           $("#errmsg").html("Please enter first name.").show();
           return false;
       }
       ...
       {           
           ...
           $("#errmsg").html("Please enter last name.").show();
           return false;
       }
       ...
       {           
           ...
           $("#errmsg").html("Please enter your mail id.").show();
           return false;
       }
       
        if (test_mail != true) {
            document.getElementById('user_mail').focus();
            $("#errmsg").html("Please enter valid mail id.").show();   
            return false;
        }
       ...
       if(feedback_input == '')
           {              
               ...
               $("#errmsg").html("Please enter your question.").show();
               return false;
           }
     ...
     if (feedback_input != '')
    {
        $.ajax
                ({
                    ...
                    data: "recipients=feedback_0&feedback_input="+encodeURIComponent(feedback_input)+"&first_name="+encodeURIComponent(first_name)+"&last_name="+encodeURIComponent(last_name)+"&user_mail="+encodeURIComponent(user_mail)+"&phone="+encodeURIComponent(phone_user),
                    ...
                    {  
                        ...
                        setTimeout("location.href=\'help_box.php?success=1\'", 1000);
                    }
                });
    }
