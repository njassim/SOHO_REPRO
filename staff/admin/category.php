...
$Category = getCategory($_REQUEST['sort']);

$active_supercategory = getSuperCategoryActiveA();
...
<html>
    ...
    <body>
                            ...
                            <td width="759" align="left" valign="top" bgcolor="#FFFFFF"><table width="759" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td align="right" valign="top"><table width="759" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="38" align="left" valign="middle" class="add_title">Add category</td>
                                                </tr>
                                                <tr>
                                                    <td height="60" align="left" valign="top" bgcolor="#f6f6f6" class="form_bg">
                                                        <form name="new_category" id="new_category" method="post" action=""  onsubmit="return validate()" >
                                                            ...
                                                            <table width="600" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td width="200" height="60" align="right" style="font-size:12px;" valign="middle">Enter Category</td>
                                                                    <td width="200" height="60" align="right" valign="middle"><input type="text" autocomplete="off" name="category_name" id="category_name" class="input_text" ></td>
                                                                    <td width="200" height="60" align="left" valign="middle">
                                                                        <select name="supercategory_name" id="supercategory_name" class="select_text" >
                                                                            ...
                                                                            <?php foreach ($active_supercategory as $categ) { ?>
                                                                ...
                                                                <tr>
                                                                    <td colspan="9" style="color:#F00; text-align:center; padding-bottom:10px; font-size: 12px;">
                                                                        ...
                                                                        if ($result == "success") {
                                                                            ...
                                                                            <script>setTimeout("location.href=\'category.php\'", 1000);</script>
                                                                            <?php
                                        ...
                                        <td align="left" valign="top">
                                            <table width="759" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="439" colspan="2" valign="middle" height="28" bgcolor="#f99b3e" align="left" class="td_brdr pad_lft"><a style="text-decoration: none; color: #fff;" href="category.php?sort=<?php echo $sort_c; ?>">category&nbsp;<img src="images/<?php echo $sort_c_img ; ?>.png"  alt="" width="10px" height="5px"/></a></td>
                                                    <td width="439" colspan="2" valign="middle" height="28" bgcolor="#f99b3e" align="left" class="td_brdr pad_lft"><a style="text-decoration: none; color: #fff;" href="category.php?sort=<?php echo $sort_c; ?>">Super category&nbsp;<img src="images/<?php echo $sort_c_img ; ?>.png"  alt="" width="10px" height="5px"/></a></td>
        ...
        <div id="toPopup"> 
            ...
            <form name="new_category1" id="new_category1" method="post" action=""  onsubmit="return validate()" >
                ...
                <div id="popup_content"> <!--your content start-->
                    <ul>
                        <li><label>Category Name</label><input type="text" autocomplete="off" name="category_name" id="category_name" value="<?php echo $editCategory[0]['category_name']; ?>" class="input_text" /></li>
                        <li><label>Status</label>
                            <div style="float:left; margin-top:5px;"><input type="radio" name="status" value="1" <?php if ($editCategory[0]['status'] == '1') echo 'checked'; ?>><p>Active</p><input type="radio" name="status" value="0" <?php if ($editCategory[0]['status'] == '0') echo 'checked'; ?>><p>Inactive</p>			
                            </div></li>
                        <li><input type="submit" value=" " value="" >
...
function validate()
{
    ...
    {
        document.getElementById("msg1").innerHTML = "Enter category";
        return false;
    }
    else
    {
    ...
    if (document.new_category.supercategory_name.value == '0')
    {
        document.getElementById("msg3").innerHTML = "Select supercategory";
        return false;
    }
    else
    {
