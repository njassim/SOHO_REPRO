                                                        ...
                                                        <form name="new_supercategory" id="new_supercategory" method="post" action=""  onsubmit="return validate()" >
                                                            ...
                                                            <table width="600" border="0" cellspacing="0" cellpadding="0" >
                                                                <tr style="float:left;">
                                                                    ...
                                                                    <input class="input_text" type="text" name="search_val" id="search_val" type="text" placeholder="Search Company" onkeydown="load_userinfo();" style="width:300px !important; margin-left: 25px;" ></td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    if (count($users) > 0) {
                                                        foreach ($users as $Prod) {
                                                            ...
                                                            <tr class="trigger" id="<?php echo $id; ?>">
                                                                ...
                                                                <td width="60"  align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>" class="pad_btm"><img class="<?php echo $staff_prev; ?> change_status_<?php echo $cumpony_id; ?>" src="images/<?php echo $status; ?>.png" id="<?php echo $cumpony_id; ?>_<?php echo $Prod['status']; ?>" width="22" height="22"  alt="Status" title="Status"/></td>
                                                                <?php if($_SESSION['user_type'] == '1'){ ?>
                                                                <td width="80"  align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>" class="pad_btm"><a href="#edit_user.php?id=<?php echo $id; ?>"><img src="images/edit.png"  alt="Edit" title="Edit" width="22" height="22"/></a><a href="customers.php?delete_id=<?php echo $id; ?>" onclick="return confirm('Are you sure?');"><img src="images/del.png"  alt="Delete" title="Delete" width="22" height="22" class="mar_lft"/></a></td>
                                                                <?php } ?>
                                                            </tr>
                                                            <tr class="test_<?php echo $id; ?>" style="display: none;">
                                                                <td colspan="<?php echo ($_SESSION['user_type'] == '1') ? '4':'3'; ?>">
                                                                                            ...
                                                                                            <table align="left">
                                                                                                <tr align="left">
                                                                                                    <td align="left">
                                                                                                        ...
                                                                                                        <div style="float:left; margin:0 4px"><img src="images/like_icon.png" style="margin-top:-3px;display: none;" alt="Update" title="Update" width="22" height="22" class="city_update city_update_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>" /></div>
                                                                                                        <div style="float:left;  margin:0 4px"><img src="images/cancel_icon.png"  style="margin-top:-4px;display: none;"  alt="Cancel" title="Cancel" width="22" height="22" class="city_cancel city_cancel_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>" /></div>,
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                        <span style="cursor: pointer;" class="bus_stat_inline bus_stat_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $state_abbr; ?></span>
                                                                                                    ...
                                                                                                    <td align="left">
                                                                                                        <span style="cursor: pointer;" class="bus_zip_inline bus_zip_inline_span_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>"><?php echo $company_zip; ?></span>
                                                                                                        <input style="float:left; width: 30px;" type="text" class="none comp_zip bus_zip_inline_txt_<?php echo $cumpony_id; ?>" id="bus_zip_inline_txt_<?php echo $cumpony_id; ?>" value="<?php echo $company_zip; ?>" />
                                                                                                        <div style="float:left; margin:0 4px"><img src="images/like_icon.png" style="margin-top:-3px;display: none;" alt="Update" title="Update" width="22" height="22" class="zip_update zip_update_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>" /></div>
                                                                                                        <div style="float:left;  margin:0 4px"><img src="images/cancel_icon.png"  style="margin-top:-4px;display: none;"  alt="Cancel" title="Cancel" width="22" height="22" class="zip_cancel zip_cancel_<?php echo $cumpony_id; ?>" id="<?php echo $cumpony_id; ?>" /></div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table> 
                                                                                        </td>
