                            ...
                            <table width="759" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td height="38" align="center" valign="middle" bgcolor="#8b8b8b" class="sub_heading">
                                            PRODUCTS
                                            <span style="float: right;padding-right: 5px;">Welcome <?php if($_SESSION['user_type'] == '1'){echo 'admin';} if($_SESSION['user_type'] == '2'){echo $_SESSION['user_name'];}?> |<a href="logout.php" style="text-decoration:none;color:#fff;">&nbsp;Logout</a></span>
                                        </td>
                                    </tr>
