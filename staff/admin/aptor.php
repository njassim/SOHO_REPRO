...
<script type="text/javascript">
    ...
    function select_cate()
    {
        ...
        if(super_id != 0)
        {
            window.location="aptor.php?ord_id="+order_id+"&superc_id="+super_id;
        }
    }
    ...
    function select_sub_cate()
    {
        ...
        if(cat_id != 0)
        {
            window.location="aptor.php?ord_id="+order_id+"&superc_id="+super_id+"&cat_id="+cat_id;
        }
    }
    ...
    {    
        var order_id = document.getElementById("order_id").value;
        window.location="aptor.php?ord_id="+order_id;
        ...
        if(super_id != '0')  
                    {
                     ...
                     ({
                        type: "POST",
                            ...
                            {
                              if(option = '1'){ 
                                   window.location="aptor.php?ord_id="+order_id+"&filter=1&superc_id="+super_id+"&cat_id="+cat_id+"&sub_id="+sub_id;
                              }
                            }
                     });
                    }
        ...
        if(search_prod != '')  
                    {
                     ...
                     ({
                        type: "POST",
                            ...
                            {
                              if(option = '1'){ 
                                   window.location="aptor.php?ord_id="+order_id+"&search="+search_prod;
                              }
                            }
                     });
                    }
