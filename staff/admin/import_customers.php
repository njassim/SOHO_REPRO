    ...
    if($_FILES['excelFile']['name']!="")
		{
			...
			{
                            $customer_company_name  =       $data->sheets[0]['cells'][$k][2];
                            $comp_name              =       compName($customer_company_name);
                            $address1               =       $data->sheets[0]['cells'][$k][21];
                            $address2               =       $data->sheets[0]['cells'][$k][22];
                            $city                   =       $data->sheets[0]['cells'][$k][23];
                            $state_val              =       $data->sheets[0]['cells'][$k][24];
                            $state                  =       State_Val($state_val);  
                            $zip                    =       $data->sheets[0]['cells'][$k][25];
                            $attention_to           =       $data->sheets[0]['cells'][$k][3];
                            if(count($check_company_name) < 1)
                                {
