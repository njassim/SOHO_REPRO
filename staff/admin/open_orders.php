                                ...
                                <td height="20" align="right" valign="top">
                                            ...
                                            <table align="right" width="240" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                ...
                                                <td><?php if($_SESSION['user_type'] == '1'){if($tax_status == '1'){ ?><a href="open_orders.php?tax_status=<?php echo $ord_id; ?>" onclick="return confirm('Are you remove the tax in this order?');"><img src="images/del.png"  alt="Remove Tax" title="Remove Tax" width="22" height="22" class="mar_lft"/></a><?php }} ?></td>
                                              </tr>
                                              <tr>
