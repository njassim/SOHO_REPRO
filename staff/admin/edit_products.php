                                        ...
                                        <td align="left" valign="top">
                                            <form name="edit_products" id="edit_products" method="post" action=""  onsubmit="return validate()" >
                                                ...
                                                <table width="759" border="0" cellspacing="0" cellpadding="0" class="add_product">
                                                    ...
                                                    <tr>
                                                        <td height="48" align="left" valign="middle" class="add_prod_label">Selling Price</td>
                                                        <td height="48" align="left" valign="middle" class="add_prod_cont"><input type="text" name="price" id="price" autocomplete="off" value="<?php echo $editProducts[0]['price']; ?>" ><div id="msg4" style="color:#FF0000"></div> </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="1" align="left" valign="middle"></td>
                                                        <td height="1"></td>
