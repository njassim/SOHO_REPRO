...
$(document).ready(function () {
	...
	//console.log( $(this).parent());
		...
		//$(this).next.toggle();
		    ...
		    $('ul.acc> li>h2>div>img').attr('src','/soho-repro/store_files/r1.png');
		    ...
		    */ //17 may
		    ...
		    //$('ul.acc> li> div.acc-section:visible').siblings('h2').children('div.eachlistfullTotal').attr('catotal','0');
	            $('ul.acc> li>div').hide();	
                    ...
                    $(this).siblings('h2').children().children().attr('src','/soho-repro/store_files/d1.png');
		    ...
		    $('ul.acc> li>div.acc-section>div.acc-content>ul.acc>li>h3>div>img').attr('src','/soho-repro/store_files/r2.png');
		    $('ul.acc> li>div.acc-section>div.acc-content>ul.acc>li>div').hide();
                    $(this).children().children().attr('src','/soho-repro/store_files/d2.png');
		   ...
		   if($(this).parent().is(":last-child")){
            ...
            display.show(); 
                ...
                if($(this)[0].tagName == 'H2') {
                    ...
                    $(this).siblings('h2').children().children().attr('src','/soho-repro/store_files/r1.png');
		    ...
		    $(this).children('div.eachlistfullTotal').css('color','#C4C4C4');
                ...
                if($(this)[0].tagName == 'H3') {
                    $(this).children().children().attr('src','/soho-repro/store_files/r2.png');
    ...
    $('.proquan').change(function () {
        ...
        $(this).parents('table').children().find('.proquan').each(function(key, element) {
            if($(element).val()) {
                subtotal = subtotal + (parseInt($(element).val()) * $(element).attr('price'));
            }
        });
       ...
       //console.log( $(this).val() );
            if($(this).val()!='')
            {
                newtotals= parseInt(newtotals) + parseInt($(this).val() * $(this).attr('price'));
            }
        })
	...
	//$(this).parent().parent().parent().parent().siblings().find('.sectionTotal').children().find('span#s_total').text();
        ...
        $(this).parents('#acc').find('.proquan').each(function(key, element) {
            if($(element).val()) {
                ...
                total = total + (parseInt($(element).val()) * $(element).attr('price'));
            }
        });
