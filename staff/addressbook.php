...
<table width="740" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#ff7e00" class="h1">
    ...
    <td width="97" align="center" valign="middle" class="brdr_2">Actions</td>
      ...
      foreach ($primary_shipping as $primary) {
                    ...
                    $comp_name = companyName($comp_id);                    
                    $address_1 = $primary['address_1'];
                    $address_2 = $primary['address_2'];  
                    $address_3 = $primary['address_3']; 
                    $city      = $primary['city'];
                    $state     = StateName($primary['state']);                    
                    $zip       = $primary['zip'];
                    $zip_ext   = $primary['zip_ext'];
                    $zip_e     = ($primary['zip_ext'] != '')? '+':'';
                    $attention = $primary['attention_to'];
                    $phone     = companyphone($comp_id);      
                    $type      = $primary['type'] ;
      ?>
  <tr bgcolor="<?php echo $rowColor; ?>">
    <td width="48" align="center" valign="middle" class="brdr_1"><?php echo $j;?></td>
    <td width="243" align="left" valign="middle" class="brdr_1"><?php echo $comp_name.'</br>'.$attention.'</br>'.$address_1.'</br>'.$address_2.'</br>'.$address_3.'</br>'.$city.',  '.$state.',  '.$zip.$zip_e.$zip_ext.'</br>'.$phone; ?></td>
      ...
      <?php
            ...
            $i = 2;
                foreach ($shipping_address as $address) {
                    ...
                    $comp_name = $address['company_name'];
                    ...
                    $attention = $address['attention_to'];
                    $phone     = $address['phone'];  
  ...
  <tr bgcolor="<?php echo $rowColor; ?>">    
    ...
    <td width="243" align="left" valign="middle" class="brdr_1"><?php echo $comp_name.'</br>'.$attention.'</br>'.$address_1.'</br>'.$address_2.'</br>'.$address_3.'</br>'.$city.',  '.$state.',  '.$zip.$zip_e.$zip_ext.'</br>'.$phone.'</br>'.$ext; ?></td>
