...
<table width="740" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
  <td align="center">
      <form name="edit_address" id="edit_address" method="post" action=""  onsubmit="return validate();" >
      ...
      <table> 
          ...
          <tr>
              ...
              <td><textarea class="addinput" name="comp" id="comp"><?php echo $editAddress[0]['company_name']; ?></textarea></td>
          </tr>
          <tr>
              <td class="lable">Attention to</td>
              <td><input type="text" class="addinput" name="attention" id="attention" value="<?php echo $editAddress[0]['attention_to']; ?>" /><div id="msg7" style="color:#FF0000;padding-left: 50px;"></div></td>
          </tr>
          <tr>
              <td class="lable">Address 1</td>
              <td><textarea class="addinput" name="add1" id="add1"><?php echo $editAddress[0]['address_1']; ?></textarea></td>
          </tr>
          <tr>
              <td class="lable">Address 2</td>
              <td><textarea class="addinput" name="add2" id="add2"><?php echo $editAddress[0]['address_2']; ?></textarea></td>
          </tr> 
          <tr>
              <td class="lable">Address 3</td>
              <td><textarea class="addinput" name="add3" id="add3"><?php echo $editAddress[0]['address_3']; ?></textarea></td>
          </tr>
          <tr>
              <td class="lable">City</td>
              <td><input type="text" class="addinput" name="city" id="city" value="<?php echo $editAddress[0]['city']; ?>" /></td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td><input type="text" class="addinput" name="zip" id="zip" value="<?php echo $editAddress[0]['zip']; ?>" /></td>
              <td class="lable">+4</td>
              <td><input type="text" class="addinput" name="zipext" id="zipext"  value="<?php echo $editAddress[0]['zip_ext']; ?>"  /></td>
          </tr>
          <tr>
              <td class="lable">Phone</td>
              <td><input type="text" class="addinput" name="phone" id="phone" value="<?php echo $editAddress[0]['phone']; ?>" /></td>
