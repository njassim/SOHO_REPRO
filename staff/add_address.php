...
if ($_REQUEST['new_address'] == '1') {    
    extract($_POST);    
    $sql = "INSERT INTO sohorepro_address
...
<table width="740" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
  <td align="center">
      <form name="new_address" id="new_address" method="post" action=""  onsubmit="return validate_();" >
      ...
      <table>
          ...
          <tr>
              <td>&nbsp;</td>
              <td>
                  <input type="submit" class="address_add" name="submit" id="submit" value="Save" /><input type="button" name="cancel" id="cancel" class="address_add" value="Cancel" onClick="javascript:window.location = '<?php echo 'addressbook.php'; ?>'" style="margin-left:15px;" />
              </td>
          </tr>
      </table>
    </form>
