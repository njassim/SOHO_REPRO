...
if (isset($_POST['customer_id']) && $_POST['customer_id'] != '') {
    ...
    '~' . $state . '~' . $customer_info[0]['comp_zipcode'] .
    '~' . $customer_info[0]['comp_phone1'] . '~' . $customer_info[0]['comp_phone2'] .
    '~' . $customer_info[0]['comp_phone3'] . '~' . $customer_info[0]['comp_phone3'] .
    '~<a href="../tax_form/'.$customer_info[0]['tax_form_resale'].'" target="_blank">' . $customer_info[0]['tax_form_resale'] . '</a>~' . $customer_info[0]['tax_form_excempt'] ;
}
