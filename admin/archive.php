...
if ($_GET['archive_id']) {
    ...
    $sql = "UPDATE sohorepro_company
			SET     archive     = '0' WHERE comp_id= '" . $archive_id . "'";
    $sql_result = mysql_query($sql);
    if ($sql_result) {
        $result = "success_status_archive";
    } else {
        $result = "failure_status_archive";
    }
}
?>
                                                ...
                                                <tr>
                                                    <td width="736" align="left" valign="middle" style="padding-left:20px;">
                                                        ...
                                                        if ($result == "success") {
                                                            ...
                                                            <script>setTimeout("location.href=\'archive.php\'", 2000);</script>
                                                            <?php
                                                        } elseif ($result == "failure") {
                                                            ?>
                                                        ...
                                                        if ($result == "success_status") {
                                                            ?>
                                                            <div style="color:#007F2A; text-align:center; padding-bottom:10px;">User account restored successfully</div>
                                                            <script>setTimeout("location.href=\'archive.php\'", 2000);</script>
                                                            <?php
                                                        } elseif ($result == "failure_status") {
                                                            ?>
                                                            <div style="color:#F00; text-align:center; padding-bottom:10px;">User account restored not successfully</div>
                                                            <script>setTimeout("location.href=\'archive.php\'", 2000);</script>       
                                                            <?php
                                                        }
                                                        ?> 
                                                        <?php
                                                        if ($result == "success_status_archive") {
                                                            ?>
                                                            <div style="color:#007F2A; text-align:center; padding-bottom:10px;">User account restored successfully</div>
                                                            <script>setTimeout("location.href=\'archive.php\'", 2000);</script>
                                                            <?php
                                                        } elseif ($result == "failure_status_archive") {
                                                            ?>
                                                            <div style="color:#F00; text-align:center; padding-bottom:10px;">User account restored not successfully</div>
                                                            <script>setTimeout("location.href=\'archive.php\'", 2000);</script>       
                                                            <?php
                                                    ...
                                                    <td height="15" align="right" valign="middle">
                                                        <span class="upt_sett" onclick="return new_acc();" style="float:right; margin-left: 5px;margin-top: 5px;">NEW ACCOUNTS</span>                                                        
                                                    </td>
                                                </tr>
                                            </table></td>
                                    </tr>
                                    <tr>
                                        <td align="right" valign="top">                                           
                                            ...
                                            if ($_REQUEST['search_cus'] != '') {
                                                ...
                                                $users_search_pre = getusers_list_search_user_Archive($search_val);
                                                if(count($users_search_pre) > 0){
                                                $users_search = getusers_list_search_user_Archive($search_val);   
                                                }else{
                                                $search_val_com_id = getCompId($_REQUEST['search_val']);
                                                if(count($search_val_com_id) > 0){
                                                foreach ($search_val_com_id as $comp_val){
                                                    $search_by_comp = getCompNameStatusArchive($comp_val['cus_compname']);
                                                }
                                                }
                                                if(count($search_by_comp) > 0){
                                                $search_by_usr_comp = trim($search_by_comp);
                                                //$search_by_comp = getCompName($search_val_com_id);
                                                $users_search = getusers_list_search_user_cus_archive($search_by_usr_comp);   
                                                }
                                                }
                                                ?>
                                            <!-- Products Start -->
                                                                                        ...
                                                                                        <table>
                                                                                            <tr>
                                                                                                <td class="comp_dtls_arc" style="padding-left: 10px;">                                                                                                    
                                                                                                    ...
                                                                                                    <?php } ?>
                                                                                                    <span style="font-size: 14px;font-weight: bold;">Resale Certificate:</span>
                                                                                                    ...
                                                                                                    <span style="font-size: 14px;font-weight: bold;">Exempt Use Certificate:</span>                                                                                                    
