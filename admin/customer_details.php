...
if ($_GET['active_id']) {
    ...
    $subject = 'Soho Repro – Account Approved';
    $headers = 'From: "SohoRepro" <no-reply@sohorepro.com>' . "\r\n";
    $headers .= "MIME-Version: 1.0" . "\r\n";
    $headers .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";
    $mail_id = $customer_info[0]['comp_contact_email'];
                                                ...
                                                if (count($UsersAll) > 0) {
                                                    foreach ($UsersAll as $users) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="60" align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>"  class="pad_btm"><a href="../tax_form/<?php echo $tax_form_resale ?>" target="_blank" title="<?php echo $tax_form_resale ?>" ><?php echo $tax_form_resale; ?></a></td>
                                                            <td width="60" align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>"  class="pad_btm"><a href="../tax_form/<?php echo $tax_form_resale ?>" target="_blank" title="<?php echo $tax_form_excempt ?>" ><?php echo $tax_form_excempt; ?></a></td>
                                                        </tr>
                                                        <?php
                                                        $i++;
                                                    }
