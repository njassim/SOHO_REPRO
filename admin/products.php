                                                ...
                                                <table width="759" border="0" cellspacing="0" cellpadding="0" class="t_tbl_repeatpro">
                                                    ...
                                                    if (count($ProductsFilter) > 0) {
                                                        ...
                                                        foreach ($ProductsFilter as $Prod) {
                                                            ...
                                                            $product_name = str_replace('"',"''",$Prod['product_name']);
                                                            ...
                                                            <tr class="inline" id="order_<?php echo $id; ?>" onclick="return edit_inline('<?php echo $id; ?>');">
                                                                ...
                                                                <td width="350" align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>" class="pad_btm"><span class="prd_span_<?php echo $id; ?>" id="prd_span_<?php echo $id; ?>"><?php echo $product_name; ?></span><input type="text" class="none inline-text-prod prd_txt_<?php echo $id; ?>" id="prd_txt_<?php echo $id; ?>" value="<?php echo $product_name; ?>"/></td>                                                               
