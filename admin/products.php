                                                ...
                                                <table width="759" border="0" cellspacing="0" cellpadding="0" class="t_tbl_repeatpro">
                                                    ...
                                                    if (count($ProductsFilter) > 0) {
                                                        ...
                                                        foreach ($ProductsFilter as $Prod) {
                                                            ...
                                                            $discount           = number_format(($Prod['discount']), 2, '.', ''); 
                                                            ...
                                                            <tr class="inline" id="order_<?php echo $id; ?>" onclick="return edit_inline('<?php echo $id; ?>');">
                                                                ...
                                                                <td width="350" align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>" class="pad_btm"><span class="prd_span_<?php echo $id; ?>" id="prd_span_<?php echo $id; ?>"><?php echo $product_name; ?></span><input type="text" class="none inline-text-prod prd_txt_<?php echo $id; ?>" id="prd_txt_<?php echo $id; ?>" value="<?php echo str_replace('"',"'",$product_name); ?>"/></td>                                                               
                                                                <td width="100" align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>"  class="pad_btm"><span class="list_span_<?php echo $id; ?>" id="list_span_<?php echo $id; ?>"><?php echo "$" . $list_price; ?></span><input type="text" class="none list_key inline-text list_txt_<?php echo $id; ?>" id="list_txt_<?php echo $id; ?>" value="<?php echo $list_price; ?>"/></td>
                                                                <td width="100" align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>"  class="pad_btm"><span class="discount_span_<?php echo $id; ?>" id="discount_span_<?php echo $id; ?>"><?php echo $discount; ?></span><input type="text" class="none discount_key inline-text discount_txt_<?php echo $id; ?>" id="discount_txt_<?php echo $id; ?>" value="<?php echo $discount; ?>"/></td>
                                                                <td width="100" align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>"  class="pad_btm"><span class="selling_span_<?php echo $id; ?>" id="selling_span_<?php echo $id; ?>"><?php echo "$" . $sell_price; ?></span><input type="text" class="none selling_key inline-text selling_txt_<?php echo $id; ?>" id="selling_txt_<?php echo $id; ?>" value="<?php echo $sell_price; ?>"/></td>
                                                                <td width="25"  align="center" valign="middle" bgcolor="<?php echo $rowColor1; ?>" class="pad_btm"><a href="products.php?filter=1&superc_id=<?php echo $su_file_id; ?>&cat_id=<?php echo $c_fil_id; ?>&sub_id=<?php echo $sc_fil_id; ?>&page_filter=<?php echo $page_id; ?>&status_id=<?php echo $id; ?>&change_id=<?php echo $Prod['status']; ?>" onclick="return confirm('Are you change the status in this product?');"><img src="images/<?php echo $status; ?>.png" width="22" height="22"  alt=""/></a></td>
                                                                <td width="64"  align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>" class="pad_btm"><img src="images/like_icon.png" onclick="update_details('<?php echo $id; ?>');"  alt="Update" title="Update" width="22" height="22" class="none update_<?php echo $id; ?>" /><a href="edit_products.php?filter=1&superc_id=<?php echo $su_file_id; ?>&cat_id=<?php echo $c_fil_id; ?>&sub_id=<?php echo $sc_fil_id; ?>&page_filter=<?php echo $page_id; ?>&id=<?php echo $id; ?>"><img src="images/edit.png"  alt="Edit" title="Edit" width="22" height="22"  class="edit_<?php echo $id; ?>" /></a><a href="products.php?filter=1&superc_id=<?php echo $su_file_id; ?>&cat_id=<?php echo $c_fil_id; ?>&sub_id=<?php echo $sc_fil_id; ?>&page_filter=<?php echo $page_id; ?>&delete_id=<?php echo $id; ?>" onclick="return confirm('Are you delete this product?');"><img src="images/del.png"  alt="Delete" title="Delete" width="22" height="22" class="mar_lft"/></a></td>                                                                
                                                            </tr>
                                                            <?php
                                                            $i++;
                                                        }
                                                    ...
                                                    if (count($ProductsFilterS) > 0) {
                                                        ...
                                                        foreach ($ProductsFilterS as $Prod) {
                                                            ...
                                                            <tr class="inline" id="<?php echo $id; ?>">
                                                                ...
                                                                <td width="64"  align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>" class="pad_btm"><img src="images/like_icon.png" onclick="update_details('<?php echo $id; ?>');"  alt="Update" title="Update" width="22" height="22" class="none update_<?php echo $id; ?>" /><a href="edit_products.php?search=<?php echo $search_val ?>&page_search=<?php echo $search_page_id; ?>&id=<?php echo $id; ?>"><img src="images/edit.png"  alt="Edit" title="Edit" width="22" height="22"  class="edit_<?php echo $id; ?>" /></a><a href="products.php?search=<?php echo $search_val ?>&page_search=<?php echo $search_page_id; ?>&delete_id=<?php echo $id; ?>" onclick="return confirm('Are you delete this product?');"><img src="images/del.png"  alt="Delete" title="Delete" width="22" height="22" class="mar_lft"/></a></td>
                                                            </tr>
                                                            <?php
                                                            $i++;
                                                        }
...
<!--                                                            <div style="float: left; margin-top: 20px;">
                                                ...
                                                <table width="759" border="0" cellspacing="0" cellpadding="0" class="t_tbl_repeatpro_j">
                                                    <?php
                                                    $i = 1;
                                                        if (count($Products) > 0) {
                                                    ...
                                                    <input type="hidden" name="page_id" id="page_id" value="<?php echo $page_id; ?>" />
                                                                ...
                                                                <td width="64"  align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>" class="pad_btm"><img src="images/like_icon.png" onclick="update_details('<?php echo $id; ?>');"  alt="Update" title="Update" width="22" height="22" class="none update_<?php echo $id; ?>" /><a href="edit_products.php?page=<?php echo $page_id; ?>&id=<?php echo $id; ?>"><img src="images/edit.png"  alt="Edit" title="Edit" width="22" height="22" class="edit_<?php echo $id; ?>"/></a><a href="products.php?page=<?php echo $page_id; ?>&delete_id=<?php echo $id; ?>" onclick="return confirm('Are you delete this product?');"><img src="images/del.png"  alt="Delete" title="Delete" width="22" height="22" class="mar_lft"/></a></td>
                                                            </tr>
...
function edit_inline(ID)
{
    <?php if($_SESSION['admin_user_type'] == '1'){ ?>
            ...
            $(".prd_txt_"+ID).show();  
            $(".update_"+ID).show(); 
            document.getElementById("prd_txt_"+ID).select();
...
function update_details(str)
    {        
        ...
        var prd_name             = document.getElementById('prd_txt_'+str).value;
        var product_id           = str; 
       // alert(str);
             if(list_price != '' && discount != '')  
	 {
	  ...
	  ({
	     type: "POST",
		 url: "get_child.php",
		 data: "id="+product_id+"&list_price_product="+list_price+"&discount_product="+discount+"&selling_product="+sell+"&prd_name="+prd_name,
...
<?php 
$page_id            = ($_GET['page_filter'] == '')? '0': $_GET['page_filter'];

        
$super_id_dnd       = ($_GET['superc_id'] == '')? '0': $_GET['superc_id']; 
$cat_id_dnd         = ($_GET['cat_id'] == '')? '0': $_GET['cat_id']; 
$sub_id_dnd         = ($_GET['sub_id'] == '')? '0': $_GET['sub_id']; 

$filter_id          = ($_GET['superc_id'] != '') ? '1' : '0';
?>
<input type="hidden" name="super_id_dnd" id="super_id_dnd" value="<?php echo $super_id_dnd; ?>" />
<input type="hidden" name="cat_id_dnd" id="cat_id_dnd" value="<?php echo $cat_id_dnd; ?>" />
<input type="hidden" name="sub_id_dnd" id="sub_id_dnd" value="<?php echo $sub_id_dnd; ?>" />

 <script language="javascript">                       
 $(function (){
      $(".t_tbl_repeatpro tbody").tableDnD({
		onDrop: function(table, row) {
			var orders          = $.tableDnD.serialize();
                        var super_id_dnd    = $('#super_id_dnd').val();
                        var cat_id_dnd      = $('#cat_id_dnd').val();
                        var sub_id_dnd      = $('#sub_id_dnd').val();
			$.post('orderpro.php', { orders : orders,super_id_dnd : super_id_dnd,cat_id_dnd : cat_id_dnd,sub_id_dnd : sub_id_dnd });
                        if(true){
                            $("#msg").html('Products order sorted successfully');
                            setTimeout("location.href=\'products.php?filter=<?php echo $filter_id; ?>&superc_id=<?php echo $super_id_dnd; ?>&cat_id=<?php echo $cat_id_dnd; ?>&sub_id=<?php echo $sub_id_dnd; ?>\'", 1000);
                        }
                }
	}); 
