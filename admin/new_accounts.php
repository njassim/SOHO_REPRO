...
if ($_GET['status_id']) {
    ...
    $sql_result = mysql_query($sql);
    $sql_user = "UPDATE sohorepro_customers SET cus_status = '1' WHERE cus_compname = '".$status_id."' ";      
...
//    $sql_result = mysql_query($sql);
    ...
    $sql_user = "DELETE FROM sohorepro_customers WHERE cus_compname = '".$archive_id."'";
    mysql_query($sql_user);
    
    $sql = "DELETE FROM sohorepro_company WHERE comp_id = " . $archive_id . " ";
    $sql_result = mysql_query($sql);
...
if ($_GET['active_id']) {
    ...
    $message .='</tr>';
    $message .='<tr>';
    $message .='<td><a href="supply.sohorepro.com/existing_customer.php" target="_blank">http://supply.sohorepro.com/existing_customer.php</a></td>';
    $message .='</tr>';
    $message .='</table>';
    $message .='</td>';
    $message .='</tr>';
    ...
    $sql_result = mysql_query($sql);
    $sql_user = "UPDATE sohorepro_customers SET cus_status = '1' WHERE cus_compname = '".$active_id."' ";      
    mysql_query($sql_user);
    if ($sql_result) {
...
<?php } ?>
        ...
        <?php echo $user_exist; ?>   
                                                            ...
                                                            <td width="80"  align="center" valign="middle" bgcolor="<?php echo $rowColor; ?>" class="pad_btm">                                                                                                                             
                                                                <a href="new_accounts.php?active_id=<?php echo $id; ?>" onclick="return confirm('Are you sure?');"><img src="images/like_icon.png" title="Restore Users"  alt="Restore Users" /></a>                                                               
                                                                <a href="new_accounts.php?delete_id=<?php echo $id; ?>" onclick="return confirm('Are you sure?');"><img src="images/del.png" title="Delete"  alt="Delete" style="cursor: pointer;" /></a>
                                                            </td>
                                                        </tr>
